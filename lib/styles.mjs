export const STYLES = [
 {id:'gold',name:'鎏金立体',sample:'鎏金',palette:['#fff7cd','#ffe590','#ffc633','#fff3ad','#df850f'],outline:'#29180d',stroke:3,depth:3,glow:0,font:'sans',highlight:false},
 {id:'ice',name:'冰晶蓝',sample:'冰晶',palette:['#ffffff','#dbfaff','#7cc9ec','#e2fbff','#6390d1'],outline:'#15345b',stroke:2.5,depth:2,glow:2,font:'sans',highlight:false},
 ...
 {id:'rose',name:'玫瑰金',sample:'玫瑰',palette:['#fff4e8','#ffd5c7','#d99180','#ffecdf','#ac605f'],outline:'#532b35',stroke:2,depth:3,glow:0,font:'serif',highlight:false},
 {id:'flame',name:'烈焰橙',sample:'烈焰',palette:['#fff8a8','#ffdf47','#ff7a25','#ffc241','#d92527'],outline:'#6a1712',stroke:3,depth:4,glow:4,font:'sans',highlight:false},
 {id:'jade',name:'翡翠绿',sample:'翡翠',palette:['#f1ffe8','#aaf7c1','#22be88','#a2f0bb','#147761'],outline:'#103f35',stroke:2,depth:2,glow:0,font:'serif',highlight:false},
 ...
 {id:'pearl',name:'珍珠雅宋',sample:'珍珠',palette:['#ffffff','#f4efff','#d3c7e9','#ffffff','#c1a3cc'],outline:'#51445c',stroke:1.5,depth:2,glow:0,font:'serif',highlight:false},
