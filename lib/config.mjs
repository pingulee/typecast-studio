...
export function validateConfig(input){
 ...
 out.highlight=false;for(const key of ['visible']){if(typeof input[key]!=='boolean')throw new Error(`请检查参数 ${key}。`);out[key]=input[key];}out.singleMode='stay';out.visible=true;return out;
}
