...
let state={config:{...structuredClone(DEFAULT_CONFIG),language:['en','ko','zh-CN'].includes(options.initialLanguage)?options.initialLanguage:'en'},revision:1},queue=Promise.resolve();const clients=new Set();
